...
The repository contains the **Phase 0 standalone geological atlas proof**, the **Phase 1 platform-neutral query core**, and the first **Phase 2 petrologic material-state increment**. It intentionally produces no Minecraft blocks: deterministic random-access geology, validated scientific identity, explainable point queries, transient column/run plans, and derived bulk-rock mineralogy are proven before coupling the model to NeoForge.
