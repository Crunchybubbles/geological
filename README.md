...
Current Phase 2 checkpoint: `phase2.0-alpha.86`, with the compact metamorphic P-T-t path vocabulary expanded to include burial heating, cold subduction, decompression exhumation, and polymetamorphic reworking.
