...
Current Phase 2 checkpoint: `phase2.0-alpha.90`, with compact metamorphic P-T-t paths and bounded principal-axis strain-frame, material-buffer, fracture-tensor, and sparse trace-element evidence.
