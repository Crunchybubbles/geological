...
block palette, and registers an Overworld generator/preset hook; fluids, regolith, and
...
item; the next engineering slice is air/fluid and regolith integration around the bounded
...
- `neoforge-adapter` is the pinned NeoForge 21.1.249 loader boundary. It contains the mod entry
  ...
  generator/preset registration; air/fluid, regolith, and dimension-native Nether/End generation
