...
block palette, and registers an Overworld generator/preset hook with explicit surface water/air;
regolith and dimension-native Nether/End generators remain future slices.
...
item; the next engineering slice is regolith/surface-clue integration around the bounded
...
- `neoforge-adapter` is the pinned NeoForge 21.1.249 loader boundary. It contains the mod entry
  ...
  generator/preset registration plus explicit surface water/air; regolith and dimension-native
