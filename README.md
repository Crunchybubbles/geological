...
applies a bounded Phase 2 regolith/surface-clue projection; dimension-native Nether/End generators
...
item; the next engineering slice is command/debug presentation around the bounded
...
- `neoforge-adapter` is the pinned NeoForge 21.1.249 loader boundary. It contains the mod entry
  ...
  generator/preset registration plus explicit surface water/air and bounded regolith/surface-clue
  projection; dimension-native Nether/End generation
