...
applies a bounded Phase 2 regolith/surface-clue projection and read-only `/geology` column traces;
dimension-native Nether/End generators remain future slices.
...
item; the next engineering slice is map/section debug overlays and compatibility/benchmark
coverage around the bounded
base-terrain/lithology writer against the frozen Phase 4 contract.
