...
and binds them to the platform-supplied executor without a live world handle. The immediate
engineering slice is a custom world preset/generator hook that turns those controls into bounded
base-terrain density and lithology writes.
