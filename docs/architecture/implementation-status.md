...
presentation remain separate. The generator/preset slice now registers a real
...
vanilla Nether/End companions until their dimension-native slices. The immediate engineering slice
is air/fluid and regolith integration without allowing vanilla surface rules to overwrite geology.
