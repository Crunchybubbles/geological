...
material-to-block resolver; air, fluids, palette registration, and debug presentation remain
separate. The immediate engineering slice is the NeoForge custom generator/world-preset hook that
invokes this writer during the platform's base-terrain callback.
