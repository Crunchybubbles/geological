...
debug presentation remain separate. The generator/preset slice now registers a real
...
is command/debug presentation and compatibility/benchmark integration without allowing vanilla
surface rules to overwrite geology.
