...
| 7 — deposit-family expansion | `phase7-alpha.8` adds the greisen residual-fluid proxy, a source-gated skarn carbonate-contact fixture, shallow epithermal and deformation/metamorphic-fluid orogenic-gold projections, separate MVT/SEDEX/sediment-hosted-copper basin/redox projections, source-gated unconformity/sandstone uranium projections, layered-intrusion chromite/Ni-Cu-PGE projections, and carbonatite/peralkaline REE plus kimberlite/diamond projections around the existing engines. All retain bounded horizons, closed source/release/loss/deposit accounting, explicit actual-host/source gates, separate kimberlite mantle-cargo evidence, chunk seams, read-only commands, and deterministic review artifacts. | 1+ family slice: phosphorite/Mn/coal/brine and geothermal families, each with dossier, data, invariants, calibration, and clues. |
