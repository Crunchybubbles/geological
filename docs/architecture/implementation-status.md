...
| 9 — comprehensive geochemistry | `phase9-alpha.3` adds bounded composition envelopes and conditional cooling/exsolution markers for all eight ideal solid-solution definitions, plus deterministic serpentine polymorph windows and review-artifact exposure. Existing ideal interpolation and sparse ledgers remain unchanged. | 1–3 slices: isotopic/provenance additions, reviewed response/partition datasets, and processing-facing assay/mineral-liberation APIs. |
