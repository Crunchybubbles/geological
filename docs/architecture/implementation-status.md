...
province owners agree, and enumerates exactly the authorized 16×16 target footprint. The immediate
engineering slice is the NeoForge custom generator/writer that applies this plan to `ChunkAccess`;
palette mapping and debug presentation must remain separate.
