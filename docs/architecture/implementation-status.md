...
| 3 — mineral systems | Six architecture families, porphyry fluid/metal zoning, gated supergene refinement, audited porphyry/VMS/LCT/potash/BIF/placer source subsets, and deterministic held-out quantile/covariance projections are implemented. | 1–2 sign-off slices: promote full-population statistics where redistributable and refine non-concentric geometry. |
