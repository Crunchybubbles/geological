...
| 4 — Minecraft vertical slice | Platform-neutral canonical Overworld/Nether/End profile identities, topology, process allow/deny sets, fluid media, vertical envelopes, and progression contracts are checked in; no NeoForge adapter or block placement yet. | 6–9 slices: NeoForge lock/adapter, Overworld terrain/material stages, clipping/caches, palette, commands/debug traces, compatibility, and benchmarks. |
