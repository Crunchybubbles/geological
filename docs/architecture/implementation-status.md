...
Porphyry, VMS, and LCT have checked-in `RAW_TABLE_AUDITED_SUBSET` resources; BIF, potash, and placer
now have complete 66-row, 102-row qualifying, and 83-row `RAW_TABLE_AUDITED` resources. Together they establish
