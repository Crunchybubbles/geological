...
| 9 — comprehensive geochemistry | `phase9-alpha.4` adds lazy K–Ar, Rb–Sr, Th–He, and U–He parent-isotope provenance evidence with fixed-point daughter-potential closure, source/age linkage, confidence, and sample/artifact exposure. It remains an accumulated-potential proxy rather than dating or daughter transport. | 1–2 slices: reviewed response/partition datasets and processing-facing assay/mineral-liberation APIs. |
