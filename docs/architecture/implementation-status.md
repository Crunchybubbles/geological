...
| 3 — mineral systems | Six architecture families, porphyry fluid/metal zoning, gated supergene refinement, audited porphyry/VMS/LCT/potash/BIF source subsets, and deterministic held-out quantile/covariance projections are implemented. | 1–2 slices: audit placer sources, promote full-population statistics, and refine non-concentric geometry. |
...
Porphyry, VMS, LCT, evaporite/potash, and BIF now have checked-in `RAW_TABLE_AUDITED_SUBSET`
resources; placer remains provisional. The remaining
