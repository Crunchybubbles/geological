...
| 7 — deposit-family expansion | `phase7-alpha.9` adds the greisen residual-fluid proxy, a source-gated skarn carbonate-contact fixture, shallow epithermal and deformation/metamorphic-fluid orogenic-gold projections, separate MVT/SEDEX/sediment-hosted-copper basin/redox projections, source-gated unconformity/sandstone uranium projections, layered-intrusion chromite/Ni-Cu-PGE projections, carbonatite/peralkaline REE plus kimberlite/diamond projections, and sedimentary phosphorite/manganese/coal/lithium-brine/potash-borate/helium-resource projections around the existing engines. All retain bounded horizons, closed source/release/loss/deposit accounting, explicit actual-host/source gates, separate kimberlite cargo evidence, porous-medium fluid/gas semantics, chunk seams, read-only commands, and deterministic review artifacts. | 1 family slice: geothermal resources, with dossier, data, invariants, calibration, and clues. |
