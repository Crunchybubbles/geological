...
now adds bounded, deterministic histogram summaries over the same column trace; the immediate
engineering slice is compatibility/benchmark integration around these debug projections without
allowing vanilla surface rules to overwrite geology.
