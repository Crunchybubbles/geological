...
| 7 — deposit-family expansion | `phase7-alpha.6` adds the greisen residual-fluid proxy, a source-gated skarn carbonate-contact fixture, shallow epithermal and deformation/metamorphic-fluid orogenic-gold projections, separate MVT/SEDEX/sediment-hosted-copper basin/redox projections, and source-gated unconformity/sandstone uranium projections around the existing engines. All retain bounded horizons, closed source/release/loss/deposit accounting, explicit actual-host/source gates, chunk seams, `/geology greisen`, `/geology skarn`, `/geology epithermal`, `/geology orogenic-gold`, `/geology basin-hydrothermal`, `/geology uranium`, and deterministic review artifacts. | 1+ family slices: layered intrusion, carbonatite/REE and kimberlite/diamond, phosphorite/Mn/coal/brine, and geothermal families, each with dossier, data, invariants, calibration, and clues. |
