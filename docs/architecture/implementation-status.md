...
Porphyry and VMS have checked-in `RAW_TABLE_AUDITED_SUBSET` resources; LCT, BIF, potash, and placer
now have complete 86-row, 66-row, 102-row qualifying, and 83-row `RAW_TABLE_AUDITED` resources. Together they establish
