...
| 6 — secondary expansion | `phase6-alpha.1` projects the gated Phase 3 gossan/oxidation/supergene Cu profile into world-column overlays with province-frame transforms, retained source budgets, barren behavior, chunk seams, a `/geology secondary` view, and a deterministic four-chunk review artifact. | 3–5 slices: bauxite/Ni-Co laterite, additional cassiterite/heavy-mineral/diamond placers, karst/regolith/paleosurfaces, and optional glacial transport. |
