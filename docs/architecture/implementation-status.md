...
fluid inference; custom palette registration and debug presentation remain separate. The generator/preset slice now registers a real
...
is regolith/surface-clue integration without allowing vanilla surface rules to overwrite geology.
